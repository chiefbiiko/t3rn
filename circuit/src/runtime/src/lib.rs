...
impl frame_system::Config for Runtime {
	...
	/// The set code logic, just the default for now.
	type OnSetCode = ();
}
...
construct_runtime!(
	...
	{
		BridgeGateway: pallet_substrate_bridge::{Pallet, Call, Storage, Config<T>},
		BridgeGatewayMessages: pallet_bridge_messages::{Pallet, Call, Storage, Event<T>},
		BridgeCallDispatch: pallet_bridge_dispatch::{Pallet, Event<T>},
		BridgeGatewayGrandpa: pallet_bridge_grandpa::{Pallet, Call},
		BridgeWestendGrandpa: pallet_bridge_grandpa::<Instance1>::{Pallet, Call},
		BridgePolkadotLikeMultiFinalityVerifier: pallet_multi_finality_verifier::<Instance1>::{Pallet, Call},
